            ...
            <div class="flex-1 min-w-0 py-2 pr-4 sm:pr-6 lg:pr-8">
                ...
                <div v-else-if="activeTab === 'profile'">
                    <div class="bg-white border border-gray-200 rounded-2xl p-6">
                        ...
                        <p class="text-sm text-gray-400 mb-5">Update your public profile information.</p>
                        ...
                        <form @submit.prevent="saveProfile" class="space-y-4 max-w-md">
                            <div>
                                ...
                                <input
                                    ...
                                    :class="profileForm.errors.name ? 'border-red-400' : 'border-gray-300'"
                                />
                ...
                <div v-else-if="activeTab === 'payouts'">
                    <div class="bg-white border border-gray-200 rounded-2xl p-6">
                        <div class="flex items-start justify-between mb-1">
                            <h2 class="text-base font-bold text-gray-900">Payouts</h2>
                        ...
                        <p class="text-sm text-gray-400 mb-6">Payouts for community and affiliate earnings.</p>
...
function saveProfile() {
    profileForm.patch('/account/settings/profile', { preserveScroll: true });
}
