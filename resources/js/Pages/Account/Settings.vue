            ...
            <div class="flex-1 min-w-0 py-2 pr-4 sm:pr-6 lg:pr-8">
                ...
                <div v-else-if="activeTab === 'kyc'">
                    <div class="bg-white border border-gray-200 rounded-2xl p-6">
                        ...
                        <!-- Approved -->
                        <div v-if="props.kyc?.status === 'approved'" class="rounded-xl border border-green-200 bg-green-50 p-4">
                        ...
                        <div v-else-if="props.kyc?.status === 'submitted'" class="rounded-xl border border-blue-200 bg-blue-50 p-4">
                            <div class="flex items-center gap-2">
                        ...
                        <!-- Rejected -->
                        <div v-else>
                            <div v-if="props.kyc?.status === 'rejected'" class="rounded-xl border border-red-200 bg-red-50 p-4 mb-6">
                                <div class="flex items-center gap-2">
                            ...
                            <form @submit.prevent="submitKyc" class="space-y-5 max-w-lg">
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        :class="idPreview ? 'border-green-300 bg-green-50' : 'border-gray-200 hover:border-indigo-300'"
                                    ...
                                    >
                                        ...
                                        <div v-else>
                                            ...
                                            <p class="text-sm text-gray-500 mt-2">Click to upload ID photo</p>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div
                                        class="border-2 border-dashed rounded-xl p-6 text-center transition-colors cursor-pointer"
                                        :class="selfiePreview ? 'border-green-300 bg-green-50' : 'border-gray-200 hover:border-indigo-300'"
                                    ...
                                    >
                                        ...
                                        <div v-else>
                                            ...
                                            <p class="text-sm text-gray-500 mt-2">Click to upload selfie with ID</p>
                                        </div>
