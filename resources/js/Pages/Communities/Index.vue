    ...
    <AppLayout title="Communities">
        ...
        <div class="text-center py-12 mb-6">
            ...
            <div class="mt-6 max-w-lg mx-auto relative">
                <svg
                    class="absolute left-3.5 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-gray-400 pointer-events-none"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                >
        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-2">
                <!-- Sort toggle -->
                <div
                    class="flex items-center gap-1 p-0.5 bg-gray-100 rounded-lg"
                >
                    <button
        ...
        <div v-if="featured.length" class="mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                    <!-- Featured badge -->
                    <div
                        class="absolute top-2 left-2 z-10 bg-indigo-600 text-white text-xs font-bold px-2.5 py-0.5 rounded-full shadow"
                    >
                        ⭐ Featured
                    </div>
                    ...
                    <div class="relative h-28 overflow-hidden">
                        ...
                        <div
                            v-else
                            class="w-full h-full bg-linear-to-br from-indigo-400 to-purple-500"
                        />
                    </div>
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between mt-3">
                            ...
                            >
                                {{
                                    c.price > 0
                                        ? `₱${Number(c.price).toLocaleString()}${c.billing_type === "one_time" ? "" : "/mo"}`
                                        : "Free"
                                }}
                            </span>
                        </div>
            ...
            >
                ...
                <div class="relative h-40 overflow-hidden">
                    ...
                    <div class="absolute top-2 left-2">
                        <span
                            class="text-xs font-bold px-2 py-0.5 rounded-full bg-black/40 text-white backdrop-blur-sm"
                        >
                            #{{ index + 1 }}
                        </span>
                    </div>
                    ...
                    >
                        <span
                            class="text-xs font-bold px-2 py-0.5 rounded-full bg-black/50 text-white backdrop-blur-sm flex items-center gap-1"
                        >
                ...
                <div class="p-4 flex flex-col flex-1">
                    <!-- Logo + name row -->
                    <div
                        class="flex items-end gap-3 -mt-3 mb-2 relative z-10"
                    >
                        <div
                    ...
                    <p
                        class="text-xs text-gray-500 line-clamp-2 leading-relaxed mb-2 h-10"
                    >
                    ...
                    <!-- Category badge -->
                    <span
                        v-if="community.category"
                        class="self-start mb-2 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-indigo-50 text-indigo-600"
                    >
                        {{ community.category }}
                    </span>
                    ...
                    <div class="flex items-center justify-between mt-auto pt-2">
                        <span class="text-xs text-gray-500 font-medium"
                            >{{ formatCount(community.members_count) }}
                            {{
        ...
        <div v-else class="text-center py-20">
            <div
                class="w-16 h-16 rounded-2xl bg-indigo-50 flex items-center justify-center mx-auto mb-4"
            >
                <svg
...
function toggleFeatured(communityId) {
    router.post(
        `/admin/communities/${communityId}/toggle-featured`,
        {},
        { preserveScroll: true },
    );
}
