            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                    ...
                    <div class="relative overflow-hidden">
                        <img v-if="c.cover_image" :src="c.cover_image" :alt="c.name" class="w-full h-auto block group-hover:scale-105 transition-transform duration-300" />
                        <div v-else class="w-full h-28 bg-linear-to-br from-indigo-400 to-purple-500" />
                    </div>
                    <div class="p-4">
