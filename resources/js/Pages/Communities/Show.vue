        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <template v-if="community.posts?.length">
                    ...
                    >
                        ...
                        <form
                            ...
                            @submit.prevent="submitEdit(post)"
                            @click.stop
                        ...
                        <img
                            v-if="post.image"
                            :src="post.image"
                            @click.stop="lightboxImg = post.image"
                        ...
                        >
                            ...
                            <div class="flex items-center gap-1">
                                <button
                                    ...
                                    :key="r.type"
                                    @click.stop="
                                        togglePostReaction(post, r.type)
                                    "
            ...
            <div class="space-y-4">
                ...
                >
                    ...
                    <div class="p-4">
                        <h3
                            class="font-bold text-gray-900 dark:text-gray-100 text-base mb-0.5"
                        >
                            {{ community.name }}
                        </h3>
                        <p class="text-xs text-gray-400 mb-2">
                            curzzo.com/communities/{{ community.slug }}
                        </p>
                        <p
                        ...
                        <div
                            v-if="isMember"
                            class="flex items-center justify-around text-center border-y border-gray-100 dark:border-gray-700 py-3 mb-4"
                        >
                            <div>
                                <p
                                    class="text-base font-black text-gray-900 dark:text-gray-100"
                                >
                        ...
                        <div
                            v-else
                            class="border-y border-gray-100 dark:border-gray-700 py-3 mb-4 text-center"
                        >
                            <p class="text-xs text-gray-400">
                                Join to see member stats
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div class="p-5">
                            ...
                            <div
                                ...
                                v-html="mdToHtml(activePost.content)"
                            />
                            <!-- Image -->
                            <img
                                v-if="activePost.image"
                                :src="activePost.image"
                                @click="lightboxImg = activePost.image"
                            ...
                            <div
                                v-if="
                                    ...
                                    getVideoEmbed(activePost.video_url)
                                "
                                class="mt-4 rounded-xl overflow-hidden aspect-video"
                            >
                                <iframe
                                    :src="getVideoEmbed(activePost.video_url)"
                                    class="w-full h-full"
                                    frameborder="0"
                                    allowfullscreen
                                />
...
function submitModalComment() {
    ...
    router.post(
        `/posts/${activePost.value.id}/comments`,
        {
            content,
...
function applyBullet() {
    ...
    const newVal =
        postForm.content.substring(0, lineStart) +
        "- " +
        postForm.content.substring(lineStart);
    postForm.content = newVal;
    el.focus();
