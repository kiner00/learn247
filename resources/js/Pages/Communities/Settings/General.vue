                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="12"
                            class="w-full px-3.5 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-y"
                        />
                        <p class="mt-1 text-xs text-gray-400">Press Enter to start a new line. Empty lines create paragraph breaks.</p>
                    </div>
