...
<body>
    <div class="card">
        ...
        <a href="{{ config('app.url') }}/communities/{{ $community->slug }}" class="btn">View Community →</a>

        <div class="footer">
            You received this because you are a member of <strong>{{ $community->name }}</strong>.<br>
