...
class CreatorController extends \App\Http\Controllers\Controller
{
    public function dashboard(): Response
    {
        ...
        $communities = Community::where('owner_id', $user->id)
            ...
            ->map(function (Community $community) {
                [$eligibleNow, $lockedAmount, $nextEligibleDate] =
                    PayoutRequestController::ownerEligibility($community);
