...
class CommunityController extends Controller
{
    ...
    public function show(Community $community, GetLeaderboard $leaderboard): Response
    {
    ...
    public function settings(Community $community): Response
    {
        ...
        $levelPerks = CommunityLevelPerk::where('community_id', $community->id)
    ...
    private function reactionCounts(Collection $likes): array
    {
