...
class RecurringCourseEnrollmentHandler extends AbstractRecurringCycleHandler
{
    ...
    {
        return CourseEnrollment::with(['course.community.owner', 'affiliate.user'])
    ...
    {
        return CourseEnrollment::STATUS_PAID;
    }
