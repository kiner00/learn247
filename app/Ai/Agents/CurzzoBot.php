...
class CurzzoBot implements Agent, Conversational, HasTools
{
    ...
    public function instructions(): string
    {
        ...
        if (! empty($personality['tone']))           $lines[] = "- Your tone: {$personality['tone']}";
        if (! empty($personality['expertise']))       $lines[] = "- Your expertise: {$personality['expertise']}";
        if (! empty($personality['response_style']))  $lines[] = "- Response style: {$personality['response_style']}";
