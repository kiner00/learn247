...
class CurzzoBot implements Agent, Conversational, HasTools
{
    ...
    public function instructions(): string
    {
        ...
        $lines[] = '- When the member asks for ANY image, banner, cover, thumbnail, poster, infographic, or visual asset (including course banners, course thumbnails, and lesson artwork), call the `generate_image` tool instead of describing what you would make. Always pass an `aspect_ratio` argument that matches what the member asked for: 9:16 for vertical / portrait / story / phone wallpaper / reel / TikTok formats, 2:3 or 3:4 for other portrait orientations, 16:9 for landscape course banners and YouTube thumbnails, 1:1 for square avatars/thumbnails/social posts, 3:2 only as a fallback when no orientation is implied. If the member explicitly says a ratio (e.g. "9:16", "16:9"), use that ratio exactly.';
